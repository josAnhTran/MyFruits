const URLCategory = 'http://localhost:9000/categoriesOnlineShopMongoose';
const URLProduct = 'http://localhost:9000/productsOnlineShopMongoose';
const URLSupplier = 'http://localhost:9000/suppliersOnlineShopMongoose';
